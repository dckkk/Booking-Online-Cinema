...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <h1 class="brand-heading">Cinema Pratama</h1>
                        <p class="intro-text">The Biggest Indonesian Cinema.</p>
                        <a href="#poster" class="btn btn-circle page-scroll">
    ...
    <!-- About Section -->
    <section id="poster" class="container content-section text-center">
        <div class="row">
    ...
    <!-- Download Section -->
    <section id="trailer" class="container content-sections text-center">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
                <h2>Trailer</h2>
                <hr>
